...
const scopeMigration = readFileSync(
  'supabase/migrations/20260919230000_isolate_current_student_academic_context.sql',
  'utf8',
);
const interventionMigration = readFileSync(
  'supabase/migrations/20260919231500_optimize_current_intervention_intelligence.sql',
  'utf8',
);
const archivedProfileMigration = readFileSync(
  'supabase/migrations/20260919232500_fix_archived_academic_profile_context.sql',
  'utf8',
);
const writingRosterMigration = readFileSync(
  'supabase/migrations/20260919234000_fix_writing_monitor_current_roster_grade.sql',
  'utf8',
);
const writingReportMigration = readFileSync(
  'supabase/migrations/20260919235500_fix_writing_current_context_reports.sql',
  'utf8',
);
const historicalWritingMigration = readFileSync(
  'supabase/migrations/20260920000500_label_historical_writing_context.sql',
  'utf8',
);
