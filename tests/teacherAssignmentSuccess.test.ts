...
const migration = readFileSync(
  'supabase/migrations/20260726024030_teacher_assignment_success_summary.sql',
  'utf8',
);
const currentYearMigration = readFileSync(
  'supabase/migrations/20260828063451_teacher_dashboard_current_year_metrics.sql',
  'utf8',
);
