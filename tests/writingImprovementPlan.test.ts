...
test('organisation weakness plan selects organisation-like target', () => {
  ...
  const result = assessWritingExam({
    ...
    targetWordCount: 140,
    studentResponse:
      'The event was a science day and it mattered because students learned and my suggestion is to add more labs because it helps students and teachers improve learning and everyone liked it',
  });
...
test('upper-grade communicative weakness plan prioritizes tone/register issues', () => {
  ...
  const result = assessWritingExam({
    ...
    targetWordCount: 150,
    studentResponse:
      'Hey guys, the event was super cool. I described it, explained why it mattered, and suggested doing it again. It was awesome and everyone should totally join next time!',
  });
...
test('improvement across attempts can shift maintenance target and produces learner feedback/monthly report', () => {
  ...
  const old3 = assessWritingExam({
    ...
    targetWordCount: 130,
    studentResponse:
      'This essay describes the event, explains why it mattered, and gives one clear suggestion for future improvement in school activities.',
  });
  const latest = assessWritingExam({
    ...
    targetWordCount: 130,
    studentResponse:
      'This essay describes the school charity event, explains why it mattered for teamwork, and gives one suggestion to improve planning and student participation.',
  });
