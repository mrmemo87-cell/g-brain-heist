-- ============================================
-- FIX: rpc_admin_reset_all HTTP 400 Error
-- ============================================
-- Run this ENTIRE script in Supabase SQL Editor
-- This forcefully drops and recreates the function with proper return type
...
-- Step 2: Recreate with properly aliased return column
...
-- Step 3: Force PostgREST to reload schema (triggers refresh)
...
WHERE n.nspname = 'public'
  AND p.proname = 'rpc_admin_reset_all';

-- Expected output:
-- function_name        | return_type                    | arguments
-- rpc_admin_reset_all  | TABLE(affected_rows integer)   | (none)

SELECT '✅ Function recreated successfully! Try the admin portal now.' AS status;
