...
(v_pool_id, 'sentence_transformation', 'The film was too frightening for the young children. (ENOUGH)', 'ENOUGH', '"The film was not suitable enough for the young children." or "The young children were not old enough to watch the film."', 1, 'hard', 'reasoning', 'too_enough', 'grammar', '''Not … enough'' is the inverse of ''too + adjective''.', 'published'),
...
-- Distribution requests 25 questions (matches ~30 min test):
...
INSERT INTO adm_blueprints (
    ...
    'english',
    9,
    27,  -- 25 × 1 mark + 2 × 2 marks (reading comp)
    45,  -- 45 minutes
    '{
