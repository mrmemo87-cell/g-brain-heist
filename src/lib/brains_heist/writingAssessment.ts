...
export const WRITING_EVALUATOR_VERSION = 'bh-writing-assessment-v3.2' as const;
export const WRITING_PREVIOUS_EVALUATOR_VERSION = 'bh-writing-assessment-v3.1' as const;
