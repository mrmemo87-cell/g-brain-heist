                    ...
                    <div className="mt-4 space-y-4">
                      ...
                      {accessMode === 'selected' ? (
                        <div className="overflow-hidden rounded-2xl border border-slate-200">
                          <div className="border-b border-blue-100 bg-blue-50 px-4 py-3 text-[11px] leading-5 text-blue-900"><strong>Registration classes stay unchanged.</strong> Selecting a student for ${name.trim() || 'this subject'} only gives them access to this subject. Their 8A / 8B / 8C placement remains their school class.</div>
