                  ...
                  {gradeLevel ? (
                    <div className="mt-4 space-y-4">
                      ...
                      <div className="grid gap-3 sm:grid-cols-2">
                        ...
                        <button type="button" onClick={() => setAccessMode('selected')} className={`rounded-2xl border p-4 text-left transition ${accessMode === 'selected' ? 'border-violet-500 bg-violet-50 ring-2 ring-violet-100' : 'border-slate-200 hover:border-slate-300'}`}><span className="text-sm font-bold text-slate-950">Selected students</span><p className="mt-1 text-xs text-slate-500">Use for ESL, electives, clubs or interventions. Students keep their normal registration class.</p></button>
                      </div>

                      {accessMode === 'selected' ? (
                        <div className="overflow-hidden rounded-2xl border border-slate-200">
                          <div className="border-b border-blue-100 bg-blue-50 px-4 py-3 text-[11px] leading-5 text-blue-900"><strong>Registration classes stay unchanged.</strong> Selecting a student for <strong>{name.trim() || 'this subject'}</strong> only gives them access to this subject. Their 8A / 8B / 8C placement remains their school class.</div>
                    ...
                    {(() => {
                      ...
                      return currentOffering ? (
                        ...
                        <div className="rounded-2xl border border-blue-100 bg-blue-50 px-4 py-4 text-xs leading-5 text-blue-900">
                          ...
                          After saving, reopen this subject and choose whether students learn in their <strong>registration classes</strong>, as a <strong>whole grade</strong>, or in a <strong>mixed-class group</strong> such as Grade 8 ESL.
                        </div>
                      );
                    })()}
                  </section>
