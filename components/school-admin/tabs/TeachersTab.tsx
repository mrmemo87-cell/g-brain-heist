...
const TeachersTab: React.FC = () => {
  ...
  return <div className="space-y-6">
    <section className="admin-section-heading"><div><p className="school-admin-eyebrow">Administration</p><h2>Teacher Allocation</h2><p>Review current teaching coverage, then allocate a teacher to a class and subject when needed.</p></div></section>
