...
const OrganisationTab: React.FC = () => {
  ...
  return <div className="space-y-5">
    <section className="admin-section-heading"><div><p className="school-admin-eyebrow">Administration</p><h2>Classes &amp; Registration</h2><p>Manage classes, year groups, teacher assignments and student placement.</p></div></section>
