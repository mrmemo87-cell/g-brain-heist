            ...
            <table className={`collective-results-table text-left text-sm ${isCustomMode ? 'is-custom-order' : ''}`}>
              ...
              <thead className="bg-slate-100 border-b border-slate-200 sticky top-0 z-10">
                <tr>
                  ...
                  {/* Average column */}
                  <th
                    className="collective-results-summary-cell collective-results-average-cell py-3 px-2 text-slate-700 font-semibold cursor-pointer hover:bg-slate-200 transition-colors select-none text-center bg-slate-200"
                ...
                {displayRows.map((row, i) => (
                  <tr
                    ...
                    className={`border-b border-slate-100 transition-colors ${
                      ...
                      isCustomMode ? 'cursor-grab active:cursor-grabbing' : 'hover:bg-cyan-50'
                    } ${
                      dragActiveIdx === i ? 'opacity-40 scale-[0.98]' : ''
                    } ${
                      dropTargetIdx === i && dragActiveIdx !== i ? 'ring-2 ring-purple-400 ring-inset bg-purple-50' : ''
                    }`}
                  >
                    ...
                    {/* Average */}
                    <td className="collective-results-summary-cell collective-results-average-cell py-3 px-2 text-center bg-slate-50">
