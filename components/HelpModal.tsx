...
const HelpModal: React.FC<HelpModalProps> = ({ onClose }) => {
  ...
  const sections: { id: HelpSection; icon: string; title: string }[] = [
    ...
    { id: 'teacher', icon: '👨‍🏫', title: 'Teacher Mode' },
  ];

  const content: Record<HelpSection, React.ReactElement> = {
    overview: (
      <div className="space-y-4">
        <h2 className="text-2xl font-bold text-cyan-400">🎮 Game Overview</h2>
        <div className="space-y-3 text-gray-300">
          ...
          <div className="bg-purple-500/10 border border-purple-500/30 rounded-lg p-4">
            <h3 className="text-lg font-bold text-purple-400 mb-2">🎯 Main Goals</h3>
          ...
          <div className="bg-cyan-500/10 border border-cyan-500/30 rounded-lg p-4">
            <h3 className="text-lg font-bold text-cyan-400 mb-2">📊 Your Stats</h3>
            <ul className="list-disc list-inside space-y-1">
    ...
    quests: (
      <div className="space-y-4">
        <h2 className="text-2xl font-bold text-cyan-400">🧠 Quests & Questions</h2>
        <div className="space-y-3 text-gray-300">
          
          <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
            <h3 className="text-lg font-bold text-green-400 mb-2">📚 Two Quest Modes</h3>
          ...
          <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-4">
            <h3 className="text-lg font-bold text-yellow-400 mb-2">🎁 Rewards</h3>
    ...
    pvp: (
      <div className="space-y-4">
        <h2 className="text-2xl font-bold text-red-400">⚔️ PvP Raids</h2>
        <div className="space-y-3 text-gray-300">
          
          <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4">
            <h3 className="text-lg font-bold text-red-400 mb-2">🎯 What is PvP?</h3>
          ...
          <div className="bg-orange-500/10 border border-orange-500/30 rounded-lg p-4">
            <h3 className="text-lg font-bold text-orange-400 mb-2">⚡ How to Raid</h3>
            <ol className="list-decimal list-inside space-y-2">
          ...
          <div className="bg-purple-500/10 border border-purple-500/30 rounded-lg p-4">
            <h3 className="text-lg font-bold text-purple-400 mb-2">🛡️ Defense</h3>
          ...
          <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
            <h3 className="text-lg font-bold text-green-400 mb-2">💰 Loot</h3>
    ...
    clans: (
      <div className="space-y-4">
        <h2 className="text-2xl font-bold text-purple-400">🏰 Clans</h2>
        <div className="space-y-3 text-gray-300">
          
          <div className="bg-purple-500/10 border border-purple-500/30 rounded-lg p-4">
            <h3 className="text-lg font-bold text-purple-400 mb-2">🤝 Why Join a Clan?</h3>
          ...
          <div className="bg-cyan-500/10 border border-cyan-500/30 rounded-lg p-4">
            <h3 className="text-lg font-bold text-cyan-400 mb-2">👥 Clan Roles</h3>
          ...
          <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
            <h3 className="text-lg font-bold text-blue-400 mb-2">🎯 How to Join/Create</h3>
          ...
          <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
            <h3 className="text-lg font-bold text-green-400 mb-2">💎 Clan Vault</h3>
    ...
    shop: (
      <div className="space-y-4">
        <h2 className="text-2xl font-bold text-amber-400">🛒 Shop & Items</h2>
        <div className="space-y-3 text-gray-300">
          
          <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-4">
            <h3 className="text-lg font-bold text-amber-400 mb-2">🛍️ What Can I Buy?</h3>
            <p>Spend your hard-earned coins on powerful items!</p>
          </div>

          <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
            <h3 className="text-lg font-bold text-blue-400 mb-2">🔵 Item Types</h3>
            <div className="space-y-3">
              <div>
          ...
          <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
            <h3 className="text-lg font-bold text-green-400 mb-2">💡 Smart Shopping Tips</h3>
            <ul className="list-disc list-inside space-y-1">
    ...
    achievements: (
      <div className="space-y-4">
        ...
        <div className="space-y-3 text-gray-300">
          ...
          <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-4">
            <h3 className="text-lg font-bold text-yellow-400 mb-2">🎯 What Are Achievements?</h3>
          ...
          <div className="bg-purple-500/10 border border-purple-500/30 rounded-lg p-4">
            <h3 className="text-lg font-bold text-purple-400 mb-2">🌟 Achievement Categories</h3>
          ...
          <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
            <h3 className="text-lg font-bold text-green-400 mb-2">📊 Track Progress</h3>
    ...
    ap: (
      <div className="space-y-4">
        <h2 className="text-2xl font-bold text-teal-400">⚡ Action Points (AP)</h2>
        <div className="space-y-3 text-gray-300">
          
          <div className="bg-teal-500/10 border border-teal-500/30 rounded-lg p-4">
            <h3 className="text-lg font-bold text-teal-400 mb-2">❓ What is AP?</h3>
          ...
          <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
            <h3 className="text-lg font-bold text-blue-400 mb-2">⚙️ How It Works</h3>
            <ul className="list-disc list-inside space-y-2">
          ...
          <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
            <h3 className="text-lg font-bold text-green-400 mb-2">♻️ Regeneration</h3>
          ...
          <div className="bg-purple-500/10 border border-purple-500/30 rounded-lg p-4">
            <h3 className="text-lg font-bold text-purple-400 mb-2">💡 Pro Tips</h3>
            <ul className="list-disc list-inside space-y-1">
    ...
    xp: (
      <div className="space-y-4">
        <h2 className="text-2xl font-bold text-blue-400">✨ XP & Leveling</h2>
        <div className="space-y-3 text-gray-300">
          
          <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
            <h3 className="text-lg font-bold text-blue-400 mb-2">📊 What is XP?</h3>
          ...
          <div className="bg-cyan-500/10 border border-cyan-500/30 rounded-lg p-4">
            <h3 className="text-lg font-bold text-cyan-400 mb-2">⬆️ Leveling Up</h3>
          ...
          <div className="bg-purple-500/10 border border-purple-500/30 rounded-lg p-4">
            <h3 className="text-lg font-bold text-purple-400 mb-2">🎁 Level Up Rewards</h3>
          ...
          <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
            <h3 className="text-lg font-bold text-green-400 mb-2">💡 Earning XP</h3>
            <div className="space-y-2">
          ...
          <div className="bg-orange-500/10 border border-orange-500/30 rounded-lg p-4">
            <h3 className="text-lg font-bold text-orange-400 mb-2">📈 Daily/Weekly Caps</h3>
    ...
    coins: (
      <div className="space-y-4">
        <h2 className="text-2xl font-bold text-amber-400">🪙 Coins & Economy</h2>
        <div className="space-y-3 text-gray-300">
          
          <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-4">
            <h3 className="text-lg font-bold text-amber-400 mb-2">💰 What Are Coins?</h3>
          ...
          <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
            <h3 className="text-lg font-bold text-green-400 mb-2">💸 Earning Coins</h3>
            <div className="space-y-2">
          ...
          <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4">
            <h3 className="text-lg font-bold text-red-400 mb-2">💸 Spending Coins</h3>
            <div className="space-y-2">
          ...
          <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-4">
            <h3 className="text-lg font-bold text-yellow-400 mb-2">⚠️ Losing Coins</h3>
          ...
          <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
            <h3 className="text-lg font-bold text-blue-400 mb-2">📊 Daily/Weekly Caps</h3>
    ...
    teacher: (
      <div className="space-y-4">
        <h2 className="text-2xl font-bold text-purple-400">👨‍🏫 Teacher Mode</h2>
        <div className="space-y-3 text-gray-300">
          
          <div className="bg-purple-500/10 border border-purple-500/30 rounded-lg p-4">
            <h3 className="text-lg font-bold text-purple-400 mb-2">📝 For Teachers</h3>
            <p>Teachers have special abilities to create educational content for students!</p>
          </div>

          <div className="bg-cyan-500/10 border border-cyan-500/30 rounded-lg p-4">
            <h3 className="text-lg font-bold text-cyan-400 mb-2">✏️ Create Questions</h3>
            <p><strong>Teachers can:</strong></p>
            <ul className="list-disc list-inside mt-2 space-y-1">
              <li>Create custom questions for students</li>
              <li>Choose subject, difficulty, and question type</li>
              <li>Add explanations for learning</li>
              <li>Set point values for questions</li>
              <li>Make questions public or private</li>
            </ul>
          </div>

          <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
            <h3 className="text-lg font-bold text-blue-400 mb-2">📊 Subjects Available</h3>
          ...
          <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
            <h3 className="text-lg font-bold text-green-400 mb-2">📤 Bulk Upload</h3>
            <p><strong>CSV Upload Feature:</strong></p>
            <ul className="list-disc list-inside mt-2">
              <li>Download CSV template</li>
              <li>Fill with multiple questions</li>
              <li>Upload all at once</li>
              <li>Save time creating content</li>
            </ul>
          </div>

          <div className="bg-orange-500/10 border border-orange-500/30 rounded-lg p-4">
            <h3 className="text-lg font-bold text-orange-400 mb-2">🎯 Question Types</h3>
            <p><strong>Multiple Choice:</strong> 4 options, one correct answer</p>
            <p><strong>True/False:</strong> Simple yes/no questions</p>
            <p><strong>Short Answer:</strong> Type the answer</p>
          </div>

          <div className="bg-pink-500/10 border border-pink-500/30 rounded-lg p-4">
            <h3 className="text-lg font-bold text-pink-400 mb-2">📈 Question Bank</h3>
            <p>Teachers can:</p>
            <ul className="list-disc list-inside mt-2">
              <li>View all created questions</li>
              <li>See usage statistics</li>
              <li>Edit existing questions</li>
              <li>Duplicate questions for variations</li>
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
      <div className="bg-gray-900 border-2 border-cyan-500/50 rounded-2xl w-full max-w-5xl max-h-[90vh] flex flex-col shadow-2xl">
        {/* Header */}
        <div className="flex items-center justify-between p-6 border-b border-gray-700">
          <h1 className="text-3xl font-bold font-heading text-cyan-400">📚 Help & Guide</h1>
          <button
            onClick={onClose}
        ...
        <div className="flex flex-1 overflow-hidden">
          {/* Sidebar */}
          <div className="w-64 border-r border-gray-700 overflow-y-auto p-4 bg-black/20">
            <div className="space-y-2">
