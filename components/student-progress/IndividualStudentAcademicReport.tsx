...
const IndividualStudentAcademicReport: React.FC<IndividualStudentAcademicReportProps> = ({ profile, schoolName, schoolLogoUrl, teacherName, onClose }) => {
  ...
  const sectionNumbers = useMemo(() => {
    ...
    return {
      overview: next++,
      focus: includeFocus ? next++ : null,
      strengths: includeStrengths ? next++ : null,
      assignments: includeAssignments ? next++ : null,
      timeline: includeTimeline ? next++ : null,
      comment: teacherComment.trim() ? next++ : null,
    };
