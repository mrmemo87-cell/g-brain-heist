...
export const listDemoBookingSlots = async (client = supabase) => {
...
export const submitDemoBooking = async (input, client = supabase) => {
...
export const checkDemoBookingAvailability = async (bookingDate, bookingTime, client = supabase) => {
...
export const listDemoBookings = async (client = supabase) => {
    const { data, error } = await client
        .from('demo_bookings')
        .select('*')
...
export const updateDemoBooking = async (id, update, client = supabase) => {
    const { data, error } = await client
        .from('demo_bookings')
        .update({
