...
import { applyCanonicalCorrections, excludeRejectedCorrections, reconcileCanonicalCorrections, } from '../supabase/functions/bh_writing_ai/canonical_corrections.js';
const correction = (source, original, better, category = 'grammar') => {
...
test('canonical reconciliation replaces every smaller overlap with one complete sentence repair', () => {
    ...
    const wholeSentence = correction(source, source, "If he left, the teacher might object; however, he couldn't abandon Daniel.", 'sentence_structure');
    ...
    assert.equal(applyCanonicalCorrections(source, canonical), "If he left, the teacher might object; however, he couldn't abandon Daniel.");
});
