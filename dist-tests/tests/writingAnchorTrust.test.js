...
import { __resetWritingIntegrationStoreForTests, getStudentWritingHubSnapshot, persistInitialWritingRichFeedback, submitInitialWritingAssessment, } from '../src/lib/brains_heist/writingIntegrationService.js';
...
test('legacy rich feedback without fingerprint is persisted in guidance-only compatibility mode', () => {
    ...
    const feedback = snapshot.data.first_attempt_rich_feedback;
    assert.ok(feedback);
