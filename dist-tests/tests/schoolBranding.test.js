...
test('canonical settings override cached profile branding', () => {
    const brand = createSchoolBrand({ schoolId: 'school-a', schoolName: 'Current Academy', schoolLogoUrl: 'https://cdn.test/current.png' }, { schoolId: 'school-a', schoolName: 'Old Academy', schoolLogoUrl: 'https://cdn.test/old.png' });
...
test('resource school wins over a viewer profile from another school', () => {
    const resource = createSchoolBrand({ schoolId: 'resource-school', schoolName: 'Resource School' }, { schoolId: 'viewer-school', schoolName: 'Viewer School' });
