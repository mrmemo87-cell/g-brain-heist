...
const migration = readFileSync('supabase/migrations/20260916195758_commander_elixirs_v1.sql', 'utf8');
const pvpMigration = readFileSync('supabase/migrations/20260916195926_commander_elixirs_pvp_visibility.sql', 'utf8');
