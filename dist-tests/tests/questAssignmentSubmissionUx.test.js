...
test('successful assignment submission waits for student acknowledgement before refreshing', () => {
    const successFlow = questView.slice(questView.indexOf("setAssignmentSubmissionState('submitted')"), questView.indexOf('} catch (error)', questView.indexOf("setAssignmentSubmissionState('submitted')")));
