...
const retiredMembershipRepair = readFileSync('supabase/migrations/20260830061952_repair_academic_profile_student_memberships.sql', 'utf8');
const reportingRoleFix = readFileSync('supabase/migrations/20260830062029_fix_academic_reporting_teacher_role_resolution.sql', 'utf8');
const rolloverGuard = readFileSync('supabase/migrations/20260830062050_guard_rollover_target_enrolment_membership.sql', 'utf8');
const liveRosterFix = readFileSync('supabase/migrations/20260830071032_fix_academic_profile_live_roster_authority.sql', 'utf8');
const operationalStudentContextFix = readFileSync('supabase/migrations/20260830105601_fix_academic_profile_operational_student_context.sql', 'utf8');
const teacherProfiles = readFileSync('components/student-progress/TeacherAcademicProfilesPage.tsx', 'utf8');
