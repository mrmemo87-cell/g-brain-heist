...
import { rpcIeltsSchoolResults } from '../services/ieltsResultsService.js';
...
test('IELTS results service and SQL avoid protected data and legacy admin paths', () => {
    ...
    const migration = fs.readFileSync(path.join(process.cwd(), 'supabase/migrations/20260516160000_ielts_school_results_foundation.sql'), 'utf8');
