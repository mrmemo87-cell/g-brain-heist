...
const authority = readFileSync('supabase/migrations/20260825120700_school_verified_question_authority.sql', 'utf8');
const evidence = readFileSync('supabase/migrations/20260825120800_school_verified_academic_profile_evidence.sql', 'utf8');
const governance = readFileSync('supabase/migrations/20260825120900_superadmin_school_question_governance.sql', 'utf8');
const inspector = readFileSync('supabase/migrations/20260825121000_superadmin_question_bank_pool_inspector_v3.sql', 'utf8');
const studentCatalog = readFileSync('supabase/migrations/20260825121100_school_verified_student_learning_catalog.sql', 'utf8');
