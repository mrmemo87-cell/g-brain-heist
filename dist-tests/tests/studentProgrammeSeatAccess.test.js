...
test('school students require an explicit active named programme-seat allocation', () => {
    const seatAuthority = migration.slice(migration.indexOf('create or replace function private.student_has_programme_seat'), migration.indexOf('revoke all on function private.student_has_programme_seat'));
