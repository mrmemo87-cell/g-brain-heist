...
const migration = readFileSync('supabase/migrations/20260812173635_allow_school_class_codes_in_user_batch_mirror.sql', 'utf8');
const placement = readFileSync('supabase/migrations/20260812172227_complete_phase3_student_placement_integrity.sql', 'utf8');
