...
const migration = readFileSync('supabase/migrations/20260913183000_commander_factions_roster.sql', 'utf8');
const styles = readFileSync('src/features/cursedCommander/commanderHeadquarters.css', 'utf8');
