...
const migration = readFileSync('supabase/migrations/20260722142215_harden_cambridge_attempt_lifecycle.sql', 'utf8');
...
const listeningPaper = readFileSync('public/cambridge-tests/English stage 9/cambridge_listening_test_1.html', 'utf8');
