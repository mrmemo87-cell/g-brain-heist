...
import { isLanguage, readLanguage, saveLanguage, translate, LANGUAGE_STORAGE_KEY } from '../src/i18n/language.js';
...
test('English fallback and interpolation preserve arbitrary names verbatim', () => {
    ...
    assert.equal(translate('ru', 'Missing message'), 'Missing message');
