export const CAMBRIDGE_WRITING_BANK_VERSION = 'cambridge-esl-writing-bank-v1';
export const CAMBRIDGE_WRITING_RUBRIC_VERSION = 'cambridge-esl-writing-rubric-v1';
const WORD_RULES = {
...
export const getCambridgeWritingProfile = (grade, _genre) => {
...
export const isOfficialIgcseWritingGenre = (genre) => ['email', 'article', 'review', 'essay', 'report'].includes(genre);
export const getCambridgeWritingTaskLabel = (grade, genre) => {
