...
export const FALLBACK_PROMPT_BY_GENRE = {
    essay: 'Your school plans to cut one student program due to budget limits. Write an essay for the principal arguing which program should be protected, why it matters to students, and one realistic improvement to make it stronger.',
    story: 'Write a short story about a student who makes a difficult choice during a school event. Show why that choice matters to the character and end with one change that could have led to a better outcome.',
    article: 'Write a school newsletter article about a recent campus or community event. Explain why it mattered to readers and propose one practical improvement for next time.',
    review: 'Write a review of a school or community event for younger students deciding whether to attend next time. Evaluate what worked, explain why it mattered, and recommend one specific improvement.',
    report: 'Write a report for school leaders about a recent activity or campaign. Summarize key outcomes, explain why they mattered, and present one evidence-based recommendation for improvement.',
    email: EMAIL_STARTER_PROMPT_TEXT,
    paragraph: 'Write one focused paragraph for your class blog about an event that affected students. Explain why it mattered and include one concrete idea to make future events better.',
};
export const STRUCTURED_WRITING_PROMPT_BANK = [
    {
        id: 'sys-email-basic-event-thanks',
        genre: 'email',
        title: 'Event thank-you with one improvement',
        prompt_text: 'Write an email to a school event organizer thanking them for a recent event. Mention two things that helped students and suggest one realistic improvement for next time.',
        grade_band: '6-8',
    ...
    },
    {
        ...
        prompt_text: 'Write an email to the student council after a school campaign. Explain what impact the campaign had, identify one problem that remained, and request one specific follow-up action.',
        grade_band: '8-10',
    ...
    },
    {
        ...
        prompt_text: 'Write a short school article about a student-life event this month. Describe what happened, why it mattered to students, and one improvement for the next event.',
        grade_band: '6-8',
    ...
    },
    {
        ...
        prompt_text: 'Write an article for your school website about a community awareness campaign. Explain the campaign goal, summarize outcomes, and recommend one next-step action for readers.',
        grade_band: '8-10',
    ...
    },
    {
        ...
        prompt_text: 'Write an article analyzing an ethics-related issue in school digital life. Compare two viewpoints, evaluate likely effects on students, and argue for one balanced school policy.',
        grade_band: '10-12',
    ...
    },
    {
        ...
        prompt_text: 'Write a review for younger students about a school club event. Explain what worked well, what could be better, and whether you recommend attending next time.',
        grade_band: '6-8',
        target_word_count: 100,
        difficulty_level: 'foundational',
    ...
    },
    {
        ...
        prompt_text: 'Write a review of a recent student competition for your school newsletter. Judge organization, fairness, and learning value, then give one clear recommendation for improvement.',
        grade_band: '8-10',
        target_word_count: 130,
        difficulty_level: 'core',
    ...
    },
    {
        ...
        prompt_text: 'Write a formal review of a community youth program for school leaders. Evaluate it against clear criteria and conclude with a justified recommendation to continue, change, or stop the program.',
        grade_band: '10-12',
        target_word_count: 180,
        difficulty_level: 'stretch',
    ...
    },
    {
        ...
        prompt_text: 'Write a story about a student who must choose between helping a friend and following school rules during an event. Show the decision and ending clearly.',
        grade_band: '6-8',
        target_word_count: 100,
        difficulty_level: 'foundational',
    ...
    },
    {
        ...
        prompt_text: 'Write a story about a student campaign that unexpectedly goes wrong. Build a clear sequence of events, show the main character’s growth, and end with a realistic solution.',
        grade_band: '8-10',
    ...
    },
    {
        ...
        prompt_text: 'Write a story in which a student team discovers an unfair practice during a community competition. Develop tension, present a moral choice, and resolve the conflict with reflection.',
        grade_band: '10-12',
    ...
    },
    {
        ...
        prompt_text: 'Write an essay arguing whether your school should change one student-life policy. Give your position, support it with reasons, and provide one practical recommendation.',
        grade_band: '6-8',
    ...
    },
    {
        ...
        prompt_text: 'Write an essay on whether schools should require students to join one community project each year. Consider benefits and challenges, then defend your final recommendation.',
        grade_band: '8-10',
    ...
    },
    {
        ...
        prompt_text: 'Write an essay evaluating whether AI writing tools should be limited in school assessments. Weigh educational value, fairness, and long-term impact before giving a reasoned conclusion.',
        grade_band: '10-12',
    ...
    },
    {
        ...
        prompt_text: 'Write a report for your teacher about a recent school event. Summarize what happened, explain the main outcomes, and include one recommendation for improvement.',
        grade_band: '6-8',
        target_word_count: 110,
        difficulty_level: 'foundational',
    ...
    },
    {
        ...
        prompt_text: 'Write a report for school leaders about results from a student campaign. Present findings, identify one key gap, and propose one evidence-based action.',
        grade_band: '8-10',
        target_word_count: 150,
        difficulty_level: 'core',
    ...
    },
    {
        ...
        prompt_text: 'Write a formal report reviewing data from a school-community program. Analyze strengths and risks, and conclude with prioritized recommendations for next term.',
        grade_band: '10-12',
        target_word_count: 210,
        difficulty_level: 'stretch',
    ...
    },
    {
        ...
        prompt_text: 'Write one paragraph for your class blog about a school activity that helped students. Include one clear example and one idea to improve the activity next time.',
        grade_band: '6-8',
    ...
    },
    {
        ...
        prompt_text: 'Write one paragraph that explains why students should join a community clean-up campaign. Keep one main idea and support it with specific detail.',
        grade_band: '8-10',
        target_word_count: 100,
        difficulty_level: 'core',
    ...
    },
    {
        ...
        prompt_text: 'Write one well-developed paragraph arguing for or against anonymous peer feedback in school. Use clear logic and precise language to support your position.',
        grade_band: '10-12',
        target_word_count: 120,
        difficulty_level: 'stretch',
...
export const WEAKNESS_TAG_TO_PROMPT_FOCUS = {
...
export const WEAKNESS_TAG_TO_MISSION_CATEGORY = {
...
export const gradeToDifficultyLevel = (grade) => {
    if (grade <= 7)
        return 'foundational';
    if (grade <= 10)
        return 'core';
...
export const toCurriculumTagsForStructuredPrompt = (prompt) => [
    `focus:${prompt.focus_tags.join('|')}`,
    `context:${prompt.context_tags.join('|')}`,
    'source:system_prompt_bank_v1',
];
export const parseFocusAndContextTags = (curriculumTags) => {
    ...
    const focusTags = (focusLine?.replace('focus:', '').split('|').filter(Boolean) ?? []);
    const contextTags = (contextLine?.replace('context:', '').split('|').filter(Boolean) ?? []);
