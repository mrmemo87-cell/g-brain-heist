...
export const getCommanderFormationPoint = (combatant) => FORMATION[combatant.id] ?? fallbackPoint(combatant);
export const getCommanderFormationPointByName = (combatants, name) => {
