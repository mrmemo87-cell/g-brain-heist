...
export interface StudentAcademicProfile {
  ...
  focus_areas: Array<{
    ...
    focus_occurrences: number;
    developing_occurrences: number;
    strength_occurrences: number;
    latest_evidence_percentage?: number | null;
    evidence_items: number;
    evidence_occurrences: number;
  }>;
  timeline: Array<{
    id: string;
    subject: string;
    ...
    skill: string;
    subskill?: string | null;
    observation_type: LearningObservationType;
    source_type: 'assignment_result' | 'writing_attempt' | 'teacher_observation' | 'import';
    source_id?: string | null;
    observed_at: string;
    evidence_percentage?: number | null;
    evidence_count: number;
    evidence_quality?: 'provisional' | 'standard' | 'strong' | null;
    contributes_to_focus_state?: boolean;
    evidence?: Record<string, unknown>;
  }>;
}

export interface StudentAcademicProfileQuery {
...
export const fetchStudentAcademicProfile = async (
  query: StudentAcademicProfileQuery = {},
