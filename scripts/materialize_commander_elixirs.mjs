...
pvpLobby = replaceIn(
  ...
  'target PvP elixir badge',
);
writeFileSync(pvpLobbyPath, pvpLobby);

console.log('Commander Supplies navigation and PvP elixir visibility materialized.');
