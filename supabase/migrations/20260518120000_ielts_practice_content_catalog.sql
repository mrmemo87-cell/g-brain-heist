...
comment on function public.rpc_ielts_practice_content_catalog(text, text, int) is 'Public-safe IELTS practice content catalog for school assignment pickers. Returns active metadata only and avoids solution fields or legacy admin checks.';
