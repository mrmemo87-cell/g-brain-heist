-- Fix Admission candidate report content_version without PL/pgSQL variable visibility hazards.
...
BEGIN
    ...
    BEGIN
      SELECT coalesce(jsonb_agg(jsonb_build_object(
          ...
          'content_version', COALESCE(q.content_version, qp.content_version),
          'topic', q.topic,
          'strand', q.strand,
          'subskill', q.subskill,
