-- Fix admission test form generation retries and order shuffling.
-- The previous shuffle updated question_order directly into the target 1..N range,
-- which can violate UNIQUE(form_id, question_order) during row swaps.
