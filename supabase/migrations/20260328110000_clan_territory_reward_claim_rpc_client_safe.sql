-- Make clan territory reward claim RPC safe for direct authenticated client invocation.

set check_function_bodies = off;

drop function if exists public.rpc_claim_clan_territory_reward(uuid, text, text, int, int, int, text, text);
...
revoke execute on function public.rpc_claim_clan_territory_reward(text, text, int, int, int, text, text) from public;
revoke execute on function public.rpc_claim_clan_territory_reward(text, text, int, int, int, text, text) from anon;
grant execute on function public.rpc_claim_clan_territory_reward(text, text, int, int, int, text, text) to authenticated;
grant execute on function public.rpc_claim_clan_territory_reward(text, text, int, int, int, text, text) to service_role;
