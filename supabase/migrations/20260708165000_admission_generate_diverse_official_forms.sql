-- Improve official admission form generation quality.
-- Keeps blueprint difficulty distribution, but prefers broad strand/subskill coverage
-- and interleaves final question order so generated papers feel less blocky.
