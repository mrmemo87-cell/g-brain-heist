-- Order admission generation blueprint buckets deterministically.
-- Preserves batch-level canonical subskill uniqueness while processing question types and difficulties in stable order.
